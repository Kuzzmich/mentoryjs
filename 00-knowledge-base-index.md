...
- [Как работает компьютер и интернет](./1.1-how-computer-and-internet-works.md)
- [Терминал / командная строка](./1.2.1-terminal-basics.md)
- [Git и GitHub](./1.2.2-git-github.md)
- [VS Code: настройка и расширения](./1.2.3-vscode.md)
- [JetBrains WebStorm](./1.2.4-webstorm.md)
- [DevTools браузера](./1.2.5-devtools.md)

...
### Задание 2.2.4.1: Обёртка для Fetch API
...
<body>
  ...
  <script>
    // TODO: Добавь функцию apiRequest здесь
    // async function apiRequest(url, options = {}) { ... }
...
### Задание 2.2.4.2: Погодное API с кэшированием
...
### Задание 2.2.4.3: Множественные запросы
...
Создай один HTML файл с встроенными стилями и скриптами. Организуй код в функции для разделения ответственности:
